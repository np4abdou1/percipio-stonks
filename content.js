...
<style>
  ...
  #pai-main{
    display:flex;flex-direction:column;width:520px;max-height:min(900px,calc(100vh - 40px));
  }
  .pai-start-btn{
  ...
  #pai-donut{
    ...
    background:var(--bg2);border-bottom:1px solid var(--border);flex-shrink:0;overflow:hidden;height:200px;
